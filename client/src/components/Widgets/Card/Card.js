...
const Card = (props) => {
  ...
  const {data} = props;
    ...
    switch(props.type){
      ...
      case 'listing':
        return(
          <div className = {`card ${props.className}`} onClick = {props.onClick ? (e)=> props.onClick(e) : null} onMouseEnter = {props.onMouseEnter ? (e)=>props.onMouseEnter(e) : null} onMouseLeave = {props.onMouseLeave ? (e)=>props.onMouseLeave(e) : null}>
